...
echo "<form id=\"subtitleForm\" method=\"POST\" onsubmit=\"return Convert();\" action=\"download.php?source={$sourcePolicy[0]}&uid={$sourcePolicy[1]}&torrent_id=0&time={$t}&sign={$sign}&filename={$filename}&uploadSubtitle=1\">\n";
